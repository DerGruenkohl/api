...
public class Multithreading {
    private static final ExecutorService executorService = Executors.newCachedThreadPool(new ThreadFactoryBuilder().setNameFormat("ArktosBot-%d").build());
    ...
    public static ScheduledFuture<?> scheduleRepeating(Runnable runnable,long initialDelay, long delay, TimeUnit timeUnit){
        return runnableExecutor.scheduleAtFixedRate(
                runnable,
                initialDelay,
                delay,
                timeUnit
